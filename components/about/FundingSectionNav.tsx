...
/**
 * Sticky table-of-contents rail beside the funding sections. Highlights the
 ...
 */
export function FundingSectionNav({ items }: { items: NavItem[] }) {
  ...
  return (
    <nav aria-label="Funding sections" className="hidden lg:block">
