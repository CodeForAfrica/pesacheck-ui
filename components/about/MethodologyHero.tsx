...
import { METHODOLOGY_HERO } from "@/lib/methodology-content";

// Dark navy hero with the radar/data artwork bleeding off the right edge; a
// left-to-right wash keeps the heading legible over the busy image. Mirrors the
// shared About hero treatment.
const HERO_GRADIENT =
...
export function MethodologyHero() {
  return (
    <section className="relative overflow-hidden bg-pesacheck-black">
      <Image
        src="/images/methodology/methodology-21.png"
        alt=""
        fill
        priority
        sizes="100vw"
