...
function ColumnGraphic({ graphic }: { graphic: "whatsapp" | "qr" }) {
  if (graphic === "whatsapp")
    return (
      <Image src="/images/whatsapp-icon.svg" alt="WhatsApp" width={120} height={120} className="size-[120px]" />
    );
  return (
    <Image
  ...
  return (
    <Container className="py-14 lg:py-[70px]">
      <div className="grid items-stretch gap-8 lg:grid-cols-[505px_1fr] lg:gap-12">
        ...
        <div className="aspect-[505/432] w-full rounded-xl bg-neutral-100" aria-hidden="true" />

        <div className="flex flex-col justify-center">
          <h2 className="text-xl font-bold text-neutral-900">{CONTACT_WHATSAPP.heading}</h2>
