...
function Section({ section }: { section: PrinciplesSection }) {
  return (
  ...
  return (
    <Container className="py-14 lg:py-[70px]">
      <div className="grid gap-12 lg:grid-cols-[180px_1fr] lg:gap-16">
        <PrinciplesSectionNav
          items={PRINCIPLES_SECTIONS.map((s) => ({ id: s.id, title: s.title }))}
        />
