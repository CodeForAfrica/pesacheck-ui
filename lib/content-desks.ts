...
export const CONTENT_DESKS: ContentDesk[] = [
  { name: "Climate Change", slug: "climate-change", image: "/images/content-desks/content2.png" },
  { name: "Gender", slug: "gender", image: "/images/content-desks/gender.png" },
  { name: "Elections", slug: "elections", image: "/images/content-desks/elections.png" },
  { name: "Public Finances", slug: "public-finances", image: "/images/content-desks/public-finance.png" },
  { name: "Scams", slug: "scams", image: "/images/content-desks/scams.png" },
  { name: "Health", slug: "health", image: "/images/content-desks/content3.png" },
  { name: "Migration", slug: "migration", image: "/images/content-desks/content4.png" },
];
